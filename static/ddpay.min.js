    ...
    1:[function(require,module,exports){
        !function(window){
            ...
            if(theUA.match(/msie\s\d+/)&&theUA.match(/msie\s\d+/)[0]||theUA.match(/trident\s?\d+/)&&theUA.match(/trident\s?\d+/)[0]){
                if((theUA.match(/msie\s\d+/)[0].match(/\d+/)[0]||theUA.match(/trident\s?\d+/)[0])<=9){
                    window.document.writeln("<pre style='text-align:center;color:#fff;background-color:#0cc; height:100%;border:0;position:fixed;top:0;left:0;width:100%;z-index:1234'><h2 style='padding-top:200px;margin:0'><strong>你的浏览器版本太low了,已经和时代脱轨了！推荐使用360浏览器！<br/></strong></h2><h2>点击下载:<a href='https://browser.360.cn/se' target='_blank' style='color:blue;'>360浏览器</a></h2><h2 style='margin:0'></h2></pre>"),
                        window.document.execCommand("Stop")
                }
            }
        }
        (window),require("./main.js"),require("./util.js"),require("./http.js"),require("./view.js")},{"./http.js":2,"./main.js":3,"./util.js":4,"./view.js":5}],2:[function(require,module,exports){
        ...
        window.DDPayHttp=DDPayHttp,DDPayHttp.post=function(url,args,cb){
            ...
            try{
                ...
                try{
                    ...
                    try{
                        ...
                        return void alert("您的浏览器不支持AJAX！")
                    }
                }
            }
        ...
        },DDPayHttp.sendPost=function(sendUrl,sendData,cb){
            DDPayHttp.post(sendUrl,sendData,function(response){
                console.log("response = "+response);
                var info={code:500};
                if(!response)return void(cb&&cb(!1,info));
                try{
                ...
                switch(info.code){
                    case 200:cb&&cb(!0,info);break;
                    default:cb&&cb(!1,info)
                }
            })
        },DDPayHttp.createOrder=function(params,cb){
            var playerId=params.playerId||"",appId=params.appId||"",goodsId=params.goodsId||"",goodsPrice=(params.goodsName,params.goodsPrice||"0"),payTo=params.payTo||"";
            ...
            if("default"==payTo||"AliPay"==payTo){
                if(!goodsId)return void alert("商品ID有误！");
                sendUrl=DDPay.postURL+"/myPay/appid_create_order",sendData="payTo="+payTo+"&playerId="+playerId+"&goodsId="+goodsId+"&appId="+appId
            }
            else
                sendUrl=DDPay.postURL+"/myPay/pay_api",sendData="payTo="+payTo+"&playerId="+playerId+"&money="+goodsPrice+"&appId="+appId;
            console.log("sendUrl: "+sendUrl+"; sendData: "+sendData),DDPayHttp.sendPost(sendUrl,sendData,
                function(bSucc,info){
                cb&&cb(bSucc,info)
            })
            ...
            return this.curOrderInfo},DDPayHttp.checkPaySucc=function(params,cb){
            var appId=(params.playerId,params.appId||""),sysTag=params.sysTag||"0";
            ...
            var sendUrl=DDPay.postURL+"/myPay/is_pay_succ",sendData="orderId="+orderId+"&appId="+appId+"&sysTag="+sysTag;
            console.log("sendUrl: "+sendUrl+"; sendData: "+sendData),DDPayHttp.sendPost(sendUrl,sendData,function(bSucc,info){cb&&cb(bSucc,info)})
        },console.log("------require httpRequest.js")
    },{}],3:[function(require,module,exports){
        var DDPay=DDPay||{};
        window.DDPay=DDPay,DDPay.postURL="http://120.78.142.80",-1!=window.location.hostname.indexOf("/mypaytest/")&&(DDPay.postURL="http://17337389lh.imwork.net:38220"),"127.0.0.1:8000/park"!=window.location.hostname&&"localhost"!=window.location.hostname||(DDPay.postURL="http://127.0.0.1:8000/park"),DDPay._debug_tag_=!0,console.log("------require main.js")
